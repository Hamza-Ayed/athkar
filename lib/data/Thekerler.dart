...
class Thekirler {
  ...
  List<Zeker> _zekerWake = [
    ...
    Zeker(
        ...
        1),
    Zeker(
        'لا إلهَ إلاّ اللّهُ وَحْـدَهُ لا شَـريكَ له، لهُ المُلـكُ ولهُ الحَمـد، وهوَ على كلّ شيءٍ قدير، سُـبْحانَ اللهِ، والحمْـدُلله ، ولا إلهَ إلاّ اللهُ واللهُ أكبَر، وَلا حَولَ وَلا قوّة إلاّ باللّهِ العليّ العظيم. رَبِّ اغْفرْ لي.',
        3),
    Zeker(
  ...
  String getZekerText() {
    return _zekerWake[_counterNumber].zekerText;
  }

  int getCorrectAnswer() {
    return _zekerWake[_counterNumber].zekerCount;
  }
}
